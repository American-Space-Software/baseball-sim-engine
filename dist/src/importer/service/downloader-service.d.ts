...
declare class DownloaderService {
    ...
    private buildRollingPlayerImports;
    buildPlayerImportsForDate(season: number, gameDate: string, filterPlayerIds?: Set<string>, forceFullReimport?: boolean): Promise<Map<string, PlayerImportRaw>>;
    getSeasonHomeFieldAdvantage(season: number): Promise<number>;
    private getRollingGamesBeforeDate;
