...
`}}Y.id="fbad4cf0aa",Y.style="\n\n\n\n";const j=Y;function K(e,{$h:t}){let s=e.vm,i=e.gameviewservice,r=e.fieldimageurl,a=e.getplayerimageurl,n=e.getplayerhref,o=e.getboxscorehref,l=e.getgameloghref,c=e.advancecallback,d=e.pausecallback,h=e.resumecallback,u=e.simtoendcallback,p=e.awaycolor||"#0A3161",m=e.homecolor||"#B31942";const g=e=>{const t=String(e).replace("#","");return.299*parseInt(t.substring(0,2),16)+.587*parseInt(t.substring(2,4),16)+.114*parseInt(t.substring(4,6),16)>160?"#000000":"#ffffff"};let f=g(p),$=g(m);const v=e=>e.lineupIds.map(t=>e.players.find(e=>e._id===t)).filter(e=>e),y=e=>null==e?"color-gray":e>=146?"color-green":e>=122?"color-blue":e>=83?"color-yellow":e>=47?"color-orange":"color-red",b=e=>null==e?"":e>=170?"A+":e>=158?"A":e>=146?"A-":e>=134?"B+":e>=122?"B":e>=110?"B-":e>=95?"C+":e>=83?"C":e>=71?"C-":e>=59?"D+":e>=47?"D":e>=35?"D-":"F",P=async()=>{c&&await c()},R=async()=>{d&&await d()},I=async()=>{h&&await h()},T=async()=>{u&&await u()};return function(t){t.$;var c=t.$h;return t.$root,t.$f7,t.$f7route,t.$f7router,t.$theme,t.$update,t.$store,c`
...
`}}V.id="81674127ec",V.style="\n\n\n";const z=V,Z=new x;function Q(e,{$onMounted:t,$onUpdated:s,$onBeforeUnmount:i,$:r,$f7:a,$update:n}){let o,l=e.gamewebservice,c=e.gameviewservice,d=e.gamemessageservice,h=e.game,u=e.fieldimageurl,p=e.getplayerimageurl,m=e.getplayerhref,g=e.getboxscorehref,f=e.getgameloghref,$=!0===e.paused,v=e.advancecallback,y=e.pausecallback,b=e.resumecallback,P=e.simtoendcallback,R=e.registerpageafterincallback,I=h?l.getGameViewModel(h):void 0,T=0,S=Promise.resolve(),E=[".at-bat-ended"],w=h;const B=()=>{if(!h)return void(I=void 0);const e=l.getGameViewModel(h);I?Object.assign(I,e):I=e},x=()=>{for(const e of E)r(e).hide()},N=()=>{o&&o.scroll(0)},D=async e=>{if(!h)return;const t=l.getCurrentDescriptions(h),s=(e=>c.getMessagesFromPlayDescriptions(e))(t);((e,t)=>{if("ENDED"===e){const e=t.find(e=>"RESULT"===e.type)?.text??"";return r(".at-bat-ended .result").text(e),void(e=>{for(const t of E)t!==e&&r(t).hide();r(e).css("display","flex")})(".at-bat-ended")}x()})(l.getAtBatState(h),t),await(async(e,t)=>{if(!o)return;const s=o.messages??[],i=d.getSync(s,e);T++;const r=T;S=S.then(async()=>{if(r===T)if(i.clear&&o.clear(),t)for(const e of i.messages){if(r!==T)return;if(o.showTyping(),await _(500),r!==T)return;o.addMessage(e),o.hideTyping()}else o.addMessages(i.messages)}),await S,N()})(s,e)},_=e=>new Promise(t=>setTimeout(t,e));return t(async()=>{h&&(B(),await n(),o=(()=>{const e=a.messages?.get(".game-messages");return e||a.messages?.create({el:".game-messages",scrollMessages:!0,scrollMessagesOnEdge:!0})})(),R&&R(N),await D(!1))}),s(async()=>{await(async()=>{$=!0===e.paused,v=e.advancecallback,y=e.pausecallback,b=e.resumecallback,P=e.simtoendcallback,R=e.registerpageafterincallback,e.game!==w&&(h=e.game,w=e.game,B(),await D(!1))})()}),i(()=>{T++,R&&R(void 0),x()}),function(e){e.$;var t=e.$h;return e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store,t`
