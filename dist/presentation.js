...
`}}Q.id="857bcc8092",Q.style="\n\n\n";const X=Q;function J(e,{$onMounted:t,$onBeforeUnmount:i,$:s,$f7:r,$update:a}){let n,o=e.gamewebservice,l=e.gameviewservice,c=e.gamemessageservice,h=e.gameplaybackservice,d=e.game,u=e.fieldimageurl,m=e.getplayerimageurl,p=e.getplayerhref,g=e.getboxscorehref,f=e.getgameloghref,$=e.updatecallback,v=e.completecallback,y=d?o.getGameViewModel(d):void 0,b=0,P=Promise.resolve(),R=[".at-bat-ended"];const I=()=>{const e=o.getGameViewModel(d);y?Object.assign(y,e):y=e},S=()=>{for(const e of R)s(e).hide()},w=e=>l.getMessagesFromPlayDescriptions(e),T=()=>{n&&n.scroll(0)},E=async(e,t)=>{if(!n)return;const i=n.messages??[],s=c.getSync(i,e);b++;const r=b;P=P.then(async()=>{if(r===b){s.clear&&n.clear();for(const e of s.messages){if(r!==b)return;if(t&&(n.showTyping(),await x(500)),r!==b)return;n.addMessage(e),n.hideTyping()}}}),await P},B=async e=>{const t=o.getCurrentDescriptions(d),i=w(t);((e,t)=>{if("ENDED"===e){const e=t.find(e=>"RESULT"===e.type)?.text??"";return s(".at-bat-ended .result").text(e),void(e=>{for(const t of R)t!==e&&s(t).hide();s(e).css("display","flex")})(".at-bat-ended")}S()})(o.getAtBatState(d),t),await a(),await E(i,e)},N=async e=>{d=e,I(),v&&await v(d),S(),await a();const t=o.getCurrentDescriptions(d);await E(w(t),!1)},x=e=>new Promise(t=>setTimeout(t,e)),D=()=>new Promise(e=>requestAnimationFrame(e));return t(async()=>{if(!d)return;h.setCallbacks(e=>(async(e,t=!0)=>{d=e,I(),$&&await $(d),await B(t)})(e,!0),N),I(),await a(),await D(),await D(),n=(()=>{const e=r.messages?.get(".game-messages");return e||r.messages?.create({el:".game-messages",scrollMessages:!0,scrollMessagesOnEdge:!0})})(),await B(!1),n&&(n.layout(),n.scroll(0));const e=s(".page[data-name='sim-game']")[0];e&&e.addEventListener("page:afterin",T,{once:!0})}),i(()=>{b++;const e=s(".page[data-name='sim-game']")[0];e&&e.removeEventListener("page:afterin",T),S(),h.pause(),h.setCallbacks()}),function(e){e.$;var t=e.$h;return e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store,t`
