        ...
        <div class="popover-inner">
          <div class="list inset list-strong list-dividers-ios">
            <ul>
              ...
              ${o?c`
                <li>
                  <a href="${o(s.game)}" class="list-button popover-close">Game Log</a>
                </li>
              `:c``}
            </ul>
          </div>
  ...
  <div class="block block-outline block-strong">
    ...
    <div class="batter-summary">
      ...
      ${n.doubles.length>0?s`
        <strong>2B:</strong> ${l(n.doubles)}<br />
      `:" "}

      ${n.triples.length>0?s`
        <strong>3B:</strong> ${l(n.triples)}<br />
      `:" "}

      ${n.homeRuns.length>0?s`
        <strong>HR:</strong> ${l(n.homeRuns)}<br />
      `:" "}

      ${n.totalBases.length>0?s`
        <strong>TB:</strong> ${l(n.totalBases)}<br />
      `:" "}

      ${n.rbi.length>0?s`
        <strong>RBI:</strong> ${l(n.rbi)}<br />
      `:" "}
